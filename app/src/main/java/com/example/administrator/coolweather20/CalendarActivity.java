...
import com.example.administrator.coolweather20.database.Day;
...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPreMonth = findViewById(R.id.tvPreMonth);
    ...
    private void initAdapter() {
        ...
        final DayAdapter adapter = new DayAdapter(dayList,this);
        ...
        updateAdapter(calendar, dayList, adapter);
    ...
    private void updateAdapter(Calendar calendar, List<Day> dayList, DayAdapter adapter) {
        dayList.clear();
        setCurrentData(calendar);
        // 得到本月一号的星期索引
