...
//        bingPicImg =(ImageView)findViewById(R.id.bing_pic_img);
    ...
    protected void onStart() {
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(EDITSTATE==0){
                    Toast.makeText(WeatherAddActivity.this,"轻触城市以删除",Toast.LENGTH_SHORT).show();
                    btn_edit.setText("确定");
                    EDITSTATE=1;
                }else if(EDITSTATE==1){
                    btn_edit.setText("删除");
    ...
    private void addBtn(String countyName, Boolean Def_flag){
        ...
        textDef.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(WeatherAddActivity.this);
                builder.setTitle("设置默认城市");
                builder.setMessage("是否将当前城市设为默认");
